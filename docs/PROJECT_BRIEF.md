        ...
        env-vault exists to solve a narrow, inspectable developer-tooling problem:
        Encrypted .env file manager — encrypt, decrypt, and manage environment secrets
        ...
        Topics: cli, dotenv, encryption, python, secrets, security

        ## Current Gates

        - Latest completed CI: success
        - Source files counted by audit: 3
        - Test files counted by audit: 2
